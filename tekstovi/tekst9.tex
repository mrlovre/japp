...
\begin{document}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.5\linewidth]{figures/ねずみ.jpg}
	\end{figure}
			
	{\Large\sloppy
		\noindent\p{「\f{腹}{はら}}\p{\f{減}{へ}った～！」と、}\p{\f{僕}{ぼく}は}\p{\f{伸}{の}びを}\p{した。}\p{そして}\p{\f{布団}{ふとん}から}\p{\f{起き上}{おきあ}がった。}\p{\f{壁}{かべ}の}\p{\f{穴}{あな}の}\p{中は、}\p{まだ}\p{\f{薄暗}{うすぐら}かった。}\p{\f{僕}{ぼく}の}\p{\f{隣}{となり}の}\p{\f{布団}{ふとん}で、}\p{\f{妹}{いもうと}は}\p{まだ}\p{ぐっすりと}\p{\f{眠}{ねむ}って}\p{いた。}\p{\f{父}{とうちゃん}ちゃんと}\p{\f{母}{かあちゃん}ちゃんも、}\p{まだ}\p{\f{起}{お}きて}\p{いない}\p{ようだった。でも、}\p{\f{僕}{ぼく}の}\p{\f{お腹}{おなか}は}\p{\f{グー}{ぐう}っと}\p{\f{鳴}{な}って、}\p{「そろそろ、}\p{\f{朝}{あさ}ごはんを}\p{\f{探}{さが}しに}\p{\f{行}{い}く}\p{\f{時間}{じかん}だ」と}\p{\f{知}{し}らせて}\p{いた。}
		...
		\noindent\p{ここに}\p{\f{引っ越}{ひっこ}して}\p{\f{来}{き}たのは、}\p{ちょうど}\p{３}\p{\f{か月}{かげつ}}\p{前だった。}\p{前に}\p{\f{住}{す}んで}\p{いた}\p{\f{穴}{あな}は、}\p{ここよりも}\p{かなり}\p{\f{狭}{せま}かった。}\p{\f{遊}{あそ}べる}\p{スペースなんて、}\p{\f{全}{まった}く}\p{なかった。}\p{そして、}\p{\f{妹}{いもうと}\f{達}{たち}が}\p{３\f{匹}{ぴき}も}\p{\f{生}{う}まれて、}\p{もっと}\p{\f{窮屈}{きゅうくつ}に}\p{なった。}\p{そんな}\p{時、}\p{\f{人間}{にんげん}に}\p{\f{見}{み}つかって}\p{しまったんだ。}
	...
	\begin{multicols}{2}[\centering 
		...
		\dictentry{探しに}{さがしに}{\item u potrazi za}{fraza}
		...
		\dictentry{音を立てる}{おとをたてる}{\item oglasiti se}{glagol (一)}
		...
		\dictentry{窮屈}{きゅくつ}{\item skučen}{imenica, na-pridjev}
	\end{multicols}
	...
	\begin{multicols}{2}[\centering \textbf{Ostalo}]
		...
		\dictentry{隣}{となり}{\item susjed}{imenica}
		...
		\dictentry{鳴る}{なる}{\item glasati se}{glagol (五)}
	...
	\begin{enumerate}
		...
		\begin{enumerate}[label=(\roman*)]
			\raggedright
			\item\vspace{0.5em}\p{\f{語り手}{かたりて}は}\p{\f{誰}{だれ}だと}\p{\f{思}{おも}いますか？}
			\rule{\linewidth}{0.5pt}\\[0.6em]
			\rule{\linewidth}{0.5pt}
			\item\vspace{0.5em}\p{\f{壁}{かべ}の}\p{\f{穴}{あな}の}\p{中の}\p{\f{住人}{じゅうにん}は}\p{いくつですか？}
			\rule{\linewidth}{0.5pt}\\[0.6em]
			\rule{\linewidth}{0.5pt}
			\item\vspace{0.5em}\p{\f{語り手}{かたりて}は}\p{何を}\p{する}\p{\f{積}{つも}りですか？}
			\rule{\linewidth}{0.5pt}\\[0.6em]
			\rule{\linewidth}{0.5pt}
			\item\vspace{0.5em}\p{\f{語り手}{かたりて}の}\p{\f{家}{いえ}の}\p{\f{掟}{おきて}は}\p{\f{何}{なん}ですか？}
			\rule{\linewidth}{0.5pt}\\[0.6em]
			\rule{\linewidth}{0.5pt}
			\item\vspace{0.5em}\p{いつ}\p{今の}\p{\f{穴}{あな}に}\p{\f{引っ越}{ひっこ}して}\p{きたのですか？}
			\rule{\linewidth}{0.5pt}\\[0.6em]
			\rule{\linewidth}{0.5pt}
		...
		\begin{center}
			\choicebox{眠っていた　・　探している　・　探しに　・　知らせました\\顔を出さない　・　確認して　・　決して　・　音を立てた\\目立つ　・　行動　・　禁止　・　全く　・　窮屈}
		\end{center}
		\begin{enumerate}[label=(\roman*)]
			\raggedright
			...
			\item \p{\f{明日}{あす}}\p{キノコを\ansline{}}\p{\f{行}{い}く、}\p{ポーションに}\p{\f{毒}{どく}}\p{キノコを}\p{\f{使}{つか}うから。}
			...
			\item \p{\f{私}{わたくし}の}\p{ポテチには\ansline{}}\p{\f{手}{て}を}\p{出すな、}\p{\f{痛}{いた}い}\p{\f{目}{め}に}\p{見るよ。}
			\item \p{\f{小屋}{ごや}の}\p{\f{屋根}{やね}は}\p{\f{雪}{ゆき}の}\p{\f{重}{おも}みで}\p{ミシミシと\ansline{}。}
			\item \p{\f{林}{はやし}に}\p{\f{竹}{たけ}が\ansline{}！}
			\item \p{\f{人間}{にんげん}は}\p{\f{狂}{くる}って}\p{いればば\ansline{}の}\p{\f{責任}{せきにん}は}\p{\f{問}{と}われない。}
			\item \p{\f{武}{たけし}\f{君}{くん}は}\p{\f{暗}{くら}い}\p{\f{道}{みち}を}\p{\f{歩}{ある}いて}\p{いるながら}\p{\f{変}{へん}な}\p{\f{音}{おと}を}\p{\f{聞}{き}いて}\p{\f{後}{うし}ろを}\p{\f{向}{む}いた、}\p{\f{築}{きず}けば}\p{\f{立ち入}{たちい}り\ansline{}の}\p{サインに}\p{\f{囲}{かこ}まれて}\p{いた。}
