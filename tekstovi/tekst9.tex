...
\begin{document}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.5\linewidth]{figures/ねずみ２.jpg}
	\end{figure}
	...
	{\Large\sloppy
		...
		\noindent\p{ここに}\p{\f{引}{ひ}っ}\p{\f{越}{こ}して}\p{\f{来}{き}たのは、}\p{ちょうど}\p{３}\p{\f{か月}{かげつ}}\p{前だった。}\p{前に}\p{\f{住}{す}んで}\p{いた}\p{\f{穴}{あな}は、}\p{ここよりも}\p{かなり}\p{\f{狭}{せま}かった。}\p{\f{遊}{あそ}べる}\p{スペースなんて、}\p{\f{全}{まった}く}\p{なかった。}\p{そして、}\p{\f{妹}{いもうと}\f{達}{たち}が}\p{３\f{匹}{ぴき}も}\p{\f{生}{う}まれて、}\p{もっと}\p{\f{窮屈}{きゅうくつ}に}\p{なった。}\p{そんな}\p{時、}\p{\f{人間}{にんげん}に}\p{\f{見}{み}つかって}\p{しまったんだ。}
