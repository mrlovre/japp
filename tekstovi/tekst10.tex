...
\begin{document}
	...
	\begin{multicols}{2}[\centering\textbf{Ostalo}]
		...
		\dictentry{３軒}{さんげん}{\item tri kuće}{brojač}
	...
	\begin{enumerate}
		...
		\begin{enumerate}[label=(\roman*)]
			\raggedright
			\item\vspace{0.5em}\p{\f{父}{とう}ちゃんは}\p{\f{新}{あたら}しい}\p{\f{壁}{かべ}の}\p{\f{穴}{あな}を}\p{\f{見}{み}つける}\p{ために}\p{何を}\p{しましたか？}
			\rule{\linewidth}{0.5pt}\\[0.6em]
			\rule{\linewidth}{0.5pt}
			...
			\rule{\linewidth}{0.5pt}\\[0.6em]
			\rule{\linewidth}{0.5pt}
			\item\vspace{0.5em}\p{\f{語}{かた}り}\p{\f{手}{て}の}\p{\f{両親}{りょうしん}は}\p{何で}\p{\f{喜}{よろこ}んで}\p{いますか？}
			\rule{\linewidth}{0.5pt}\\[0.6em]
			\rule{\linewidth}{0.5pt}
		\end{enumerate}		
		...
		\begin{enumerate}[label=(\roman*)]
			...
			\item \p{\f{石子}{いしこ}は}\p{「\f{昨日}{きのう}}\p{\f{本屋}{ほんや}で\ansline{}}\p{\f{数}{すう}}\p{\f{時間}{じかん}は}\p{\f{幻想}{げんそう}\f{的}{てき}でした」と}\p{\f{金魚}{きんぎょ}の}\p{\f{幸子}{さちこ}ちゃんに}\p{話しました。}
			\item \p{\f{去年}{きょねん}}\p{\f{明子}{あきこ}の}\p{\f{村}{むら}で}\p{\f{巨大}{きょだい}な}\p{\f{壁}{かべ}を}\p{\f{作}{つく}る}\p{ために}\p{\f{近郊}{きんこう}の}\p{\f{森}{もり}を}\p{\f{全部}{ぜんぶ}}\p{\f{切}{き}り}\p{\f{落}{お}とすことが\ansline{}が、}\p{\f{明子}{あきこ}は}\p{今でも}\p{それを}\p{\f{止}{と}めようと}\p{して}\p{いる。}
			\item \p{\f{花子}{はなご}ちゃん、}\p{\f{武}{たけし}\f{君}{くん}を\ansline{}}\p{ビーチに}\p{\f{来}{き}てね、}\p{スイカ}\p{\f{割}{わり}}\p{するから。}
			\item\p{\f{彼}{かれ}は}\p{その}\p{\f{文書}{ぶんしょ}の\ansline{}の}\p{\f{意味}{いみ}を}\p{\f{説明}{せつめい}}\p{した。}
			\item \p{\f{腕}{うで}を}\p{\f{蚊}{か}に}\p{\f{刺}{さ}されて}\p{いるのに\ansline{}。}
			\item \p{\f{人}{ひと}ごみに}\p{そんなに}\p{\f{長}{なが}く}\p{いるのは\ansline{}に}\p{\f{悪}{わる}い。}
			\item \p{\f{先週}{せんしゅう}}\p{\f{山}{やま}を}\p{\f{登}{のぼ}りに}\p{\f{行}{い}ったけど\ansline{}に}\p{\f{疲}{つか}れて}\p{五}\p{\f{時間}{じかん}も}\p{かかったのさ。}
			...
			\item \p{\f{消防}{しょうぼう}\f{車}{しゃ}が\ansline{}}\p{した}\p{時に}\p{ラブ}\p{ホテルは}\p{すでに}\p{\f{燃}{も}え}\p{\f{尽}{つ}きた。}
		\end{enumerate}
	\end{enumerate}
\end{document}