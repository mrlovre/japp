...
\begin{document}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.5\linewidth]{figures/ねずみ４.jpeg}
	\end{figure}
	...
	\begin{multicols}{2}[\centering\textbf{Bitno}]\noindent
		...
		\dictentry{眩しい}{まぶしい}{\item sjajan, zračeći}{i-pridjev}
		...
		\dictentry{はみ出す}{はみだす}{\item proviriti}{glagol (五)}
	\end{multicols}
	...
	\begin{multicols}{2}[\centering\textbf{Ostalo}]
		...
		\dictentry{達}{たち}{\item množina}{sufiks}
		\dictentry{置く}{おく}{\item smjestiti}{glagol (五)}
		...
		\dictentry{通る}{とおる}{\item proći}{glagol (五)}
		\dictentry{廊下}{ろうか}{\item hodnik}{imenica}
		\dictentry{方}{ほう}{\item smjer, način}{imenica}
		\dictentry{向かう}{むかう}{\item ići prema}{glagol (五)}
		...
		\dictentry{聞こえる}{きこえる}{\item čuti se}{glagol (五)}
		\dictentry{探す}{さがす}{\item tražiti}{glagol (五)　}
		\dictentry{座布団}{ざぶとん}{\item jastuk za sjedenje}{imenica}
		\dictentry{上}{うえ}{\item iznad}{imenica, no-pridjev, prilog}
		\dictentry{見える}{みえる}{\item vidjeti se}{glagol (五)}
	...
	\begin{enumerate}
		...
		\begin{enumerate}[label=(\roman*)]
			...
			\rule{\linewidth}{0.5pt}\\[0.6em]
			\rule{\linewidth}{0.5pt}
			\item\vspace{0.5em}\p{\f{語}{かた}り}\p{\f{手}{て}は}\p{なぜ}\p{\f{人間}{にんげん}たちは}\p{\f{仏壇}{ぶつだん}や}\p{\f{本棚}{ほんだな}を}\p{\f{壁}{かべ}の}\p{\f{穴}{あな}の}\p{前に}\p{\f{置}{お}くのだと}\p{\f{思}{おも}って}\p{いる？}
			\rule{\linewidth}{0.5pt}\\[0.6em]
			\rule{\linewidth}{0.5pt}
		...
		\begin{center}
			\choicebox{眩しい　・　隙間　・　隠している　・　寝っ転がっている　・　本棚\\完璧　・　遠く　・　はみ出ている　・　日向ぼっこ　}
		\end{center}
		\begin{enumerate}[label=(\roman*)]
			\raggedright
			...
			\item \p{\ansline{}な}\p{ワン}\p{ピースを}\p{\f{昨日}{きのう}\f{店}{みせ}で}\p{\f{見}{み}つけたけど}\p{\f{今月}{こんげつ}\f{金}{かね}は}\p{ちょっと}\p{きついので}\p{\f{買}{か}わなかった。}
			...
			\item \p{\f{彼}{かれ}らは}\p{\f{老人}{ろうじん}に}\p{\f{出}{で}}\p{\f{会}{あ}ったときにまだ\ansline{}へ}\p{\f{行}{い}かなかった。}
