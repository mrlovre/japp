...
\begin{document}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.5\linewidth]{figures/ねずみ５.jpg}\includegraphics[width=0.5\linewidth]{figures/ねずみ７.jpeg}
	\end{figure}
	...
	\begin{multicols}{2}[\centering\textbf{Bitno}]\noindent
		\dictentry{交換}{こうかん}{\item razmjena}{imenica, suru-glagol}
	...
	\begin{multicols}{2}[\centering\textbf{Ostalo}]
		...
		\dictentry{楽しにする}{たのしにする}{\item veseliti se}{suru-glagol}
		...
		\dictentry{４匹}{よんひき}{\item 4 male životinje}{brojač}
		\dictentry{日}{ひ}{\item dan}{imenica}
		\dictentry{良い}{よい}{\item dobro}{i-pridjev}
	\end{multicols}
        \footnotetext{U tekstu ovaj glagol čudno izgleda zato što je stavljen u svoju 敬語-謙譲語(けいごーけんじょうご) verziju koja se tvori tako da se ispred korjena glagola stavi お ili ご, a iza se stavi glagol する u odgovarajućem obliku.}
	...
	\begin{enumerate}
		...
		\begin{enumerate}[label=(\roman*)]
			...
			\rule{\linewidth}{0.5pt}\\[0.6em]
			\rule{\linewidth}{0.5pt}
			\item\vspace{0.5em}\p{\f{家族}{かぞく}は}\p{何を}\p{\f{楽}{たの}しみに}\p{して}\p{いた？}
			\rule{\linewidth}{0.5pt}\\[0.6em]
			\rule{\linewidth}{0.5pt}
		...
		\begin{enumerate}[label=(\roman*)]
			...
			\item \p{ほか}\p{ほかの\ansline{}}\p{て}\p{\f{ご飯}{はん}が}\p{\f{食}{た}べたい。}
			\item \p{\f{私}{わたくし}は}\p{\f{古}{こ}}\p{\f{新聞}{しんぶん}を}\p{\f{ちり紙}{ちりがみ}と\ansline{}。}
