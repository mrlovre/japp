...
\begin{document}
	...
	\begin{center}
		\Huge \f{地震}{じしん}が\f{起}{お}こったら、その２
	\end{center}
	\vspace{2em}
	...
	{\Large\sloppy
		...
		\p{\f{狭}{せま}い}\p{\f{場所}{ばしょ}で}\p{\f{長}{なが}い}\p{\f{時間}{じかん}}\p{\f{体}{たい}を}\p{\f{動}{うご}かさないと、}\p{「エコノミー}\p{クラス}\p{\f{症候}{しょうこう}}\p{\f{群}{ぐん}」と}\p{いう}\p{\f{病気}{びょうき}に}\p{なる}\p{ことも}\p{あります。}\p{車の}\p{中で}\p{\f{生活}{せいかつ}を}\p{する}\p{\f{人}{ひと}は}\p{\f{特}{とく}に}\p{\f{気}{き}を}\p{つけましょう。}
