...
\begin{document}
	...
	{\Large\sloppy
		...
		\p{\f{建物}{たてもの}が}\p{\f{壊}{こわ}れたり}\p{して}\p{\f{家}{いえ}で}\p{\f{生活}{せいかつ}が}\p{できなく}\p{なった}\p{\f{場合}{ばあい}、}\p{\f{市}{し}や}\p{\f{町}{まち}などが}\p{\f{決}{き}めた}\p{「\f{避難}{ひなん}\f{所}{じょ}」に}\p{しばらく}\p{いる}\p{ことが}\p{できます。}\p{\f{大勢}{おおぜい}の}\p{\f{人}{ひと}と}\p{\f{一緒}{いっしょ}に}\p{\f{生活}{せいかつ}を}\p{しますから、}\p{\f{健康}{けんこう}に}\p{\f{気}{き}を}\p{つけましょう。}
